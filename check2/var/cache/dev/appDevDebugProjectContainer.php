...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nYYe9Hm4yx', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U+nvfu1TCE', 0, 'wQhjlKIZOIVDoXgIAH5+91', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'commitstrip', 'user' => 'root', 'password' => '5kartvas', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CommitStripBundle/Entity'))), 'CommitStripBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CommitStripBundle' => 'CommitStripBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6fad8a14f0541c14061d2790f18b2053c26aaa7fc2d86781d1c4f9de60a3a9b6');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SubjectBundle/Resources/views'), 'Subject');
        $instance->addPath(($this->targetDirs[3].'/src/CommitStripBundle/Resources/views'), 'CommitStrip');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JZpvkKWjyV', 0, 'wQhjlKIZOIVDoXgIAH5+91', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f08f9ac97a85.02019517')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'SubjectBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/SubjectBundle'),
                    'namespace' => 'SubjectBundle',
                ),
                'CommitStripBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CommitStripBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SubjectBundle' => 'SubjectBundle\\SubjectBundle',
                'CommitStripBundle' => 'CommitStripBundle\\CommitStripBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'commitstrip',
            'database_user' => 'root',
            'database_password' => '5kartvas',
